...
let AdminController = class AdminController {
    ...
    articlesService;
    commentsService;
    constructor(portfolioService, articlesService, commentsService) {
...
__decorate([
    ...
    (0, common_1.Render)('admin/portfolio'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], AdminController.prototype, "getPortfolio", null);
__decorate([
    (0, common_1.Get)('articles'),
    (0, common_1.Render)('admin/articles'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    (0, common_1.Render)('admin/comments'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
